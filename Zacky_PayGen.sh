...
function doHelp {
  ...
  echo ""
  echo -e " Rather than putting <DOMAIN/IP>, you can do a interface and Zacky_PayGen will detect that IP address."
...
## Banner
echo -e " ${BLUE}[*]${RESET} ${BLUE}MSF${RESET}venom ${BLUE}P${RESET}ayload ${BLUE}C${RESET}reator (${BLUE}Zacky_PayGen${RESET} v${BLUE}1.4.5${RESET})"
